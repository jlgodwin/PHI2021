          ...
          div(
            ...
            fluidRow(
              ...
              column(
                ...
                #hhsize NEW: To add to Jessica's rea
                box(
                  width = NULL,
                  selectInput(
                    inputId = "size",
                ...
                box(
                  ...
                  radioButtons(
                    inputId = "var",
                    label = "Variable",
                    choices = c("Education Level", "Population", "Rent Burden", "Household Size","Median Income", "Methods of Transportation to Work - Median Age", "Median Gross Rent"),
