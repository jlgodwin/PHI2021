...
if(!dir.exists('../Race and Education Data and Plots/HRA/')){
  ...
  dir.create('../Race and Education Data and Plots/HRA/Population/')
  dir.create('../Race and Education Data and Plots/HRA/Prevalence/')
  dir.create('../Race and Education Data and Plots/HRA/Distribution/')
  dir.create('../Race and Education Data and Plots/Tract/')
  dir.create('../Race and Education Data and Plots/Tract/Population/')
  dir.create('../Race and Education Data and Plots/Tract/Prevalence/')
  dir.create('../Race and Education Data and Plots/Tract/Distribution/')
}
...
for(yr in c(2019, 2014, 2009)){
  for(edu_lvl in unique(edu_data_hra$Education)){
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Population/", edu_lvl,"_White_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Prevalence/", edu_lvl, "_Prevalence_White_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Prevalence/", edu_lvl, "_Prevalence_White_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Distribution/", edu_lvl, "_Distribution_White_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Distribution/", edu_lvl, "_Distribution_White_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
...
for(yr in c(2019, 2014, 2009)){
  for(edu_lvl in unique(edu_data_hra$Education)){
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Population/", edu_lvl,"_Black_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Prevalence/", edu_lvl, "_Prevalence_Black_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Prevalence/", edu_lvl, "_Prevalence_Black_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Distribution/", edu_lvl, "_Distribution_Black_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Distribution/", edu_lvl, "_Distribution_Black_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
...
for(yr in c(2019, 2014, 2009)){
  for(edu_lvl in unique(edu_data_hra$Education)){
    ...
    title(paste0("\n",
                 "American Indian/Alaska Native (ACS ",
                 yr - 5, "-", yr,")"),
          font.main = 1, outer = FALSE,
          adj = 0, cex.main = 1)
    dev.off()
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Prevalence/", edu_lvl, "_Prevalence_AIAN_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Prevalence/", edu_lvl, "_Prevalence_AIAN_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Distribution/", edu_lvl, "_Distribution_AIAN_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Distribution/", edu_lvl, "_Distribution_AIAN_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
...
for(yr in c(2019, 2014, 2009)){
  for(edu_lvl in unique(edu_data_hra$Education)){
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Population/", edu_lvl,"_Asian_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Prevalence/", edu_lvl, "_Prevalence_Asian_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Prevalence/", edu_lvl, "_Prevalence_Asian_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Distribution/", edu_lvl, "_Distribution_Asian_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Distribution/", edu_lvl, "_Distribution_Asian_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
...
for(yr in c(2019, 2014, 2009)){
  for(edu_lvl in unique(edu_data_hra$Education)){
    ...
    title(paste0("\n",
                 "Native Hawaiian/Pacific Islander, (ACS ",
                 yr - 5, "-", yr,")"),
          font.main = 1, outer = FALSE,
          adj = 0, cex.main = 1)
    dev.off()
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Population/", edu_lvl,"_NHOPI_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Prevalence/", edu_lvl, "_Prevalence_NHOPI_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Prevalence/", edu_lvl, "_Prevalence_NHOPI_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Distribution/", edu_lvl, "_Distribution_NHOPI_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Distribution/", edu_lvl, "_Distribution_NHOPI_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
...
for(yr in c(2019, 2014, 2009)){
  for(edu_lvl in unique(edu_data_hra$Education)){
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Population/", edu_lvl,"_Other_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Prevalence/", edu_lvl, "_Prevalence_Other_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Prevalence/", edu_lvl, "_Prevalence_Other_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Distribution/", edu_lvl, "_Distribution_Other_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Distribution/", edu_lvl, "_Distribution_Other_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
...
edu_data_hra_tmp <- edu_data_hra %>% 
  filter(grepl("C15002A", variable) | 
           grepl("C15002B", variable) |
           grepl("C15002C", variable) |
           grepl("C15002D", variable) |
           grepl("C15002E", variable) |
           grepl("C15002F", variable) ) %>% 
  group_by(Year, FID_HRA_20, HRA2010v2_,
           Education) %>% 
  summarise(estimate = sum(estimate),
            SE = sum(SE)) %>% 
...
for(yr in c(2019, 2014, 2009)){
  for(edu_lvl in unique(edu_data_hra$Education)){
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Prevalence/", edu_lvl, "_Prevalence_All_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Prevalence/", edu_lvl, "_Prevalence_All_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
    ...
    jpeg(paste0("../Race and Education Data and Plots/HRA/",
                "Distribution/", edu_lvl, "_Distribution_All_",
                yr, ".jpeg"),
         height = 480, width = 480)
    par(lend = 1,
        mar = c(0,0,2,0),
    ...
    jpeg(paste0("../Race and Education Data and Plots/Tract/",
                "Distribution/", edu_lvl, "_Distribution_All_CoV_",
                yr, ".jpeg"),
         height = 480, width = 480)
    {
      par(lend = 1,
