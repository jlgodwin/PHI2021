...
age_vars <- var_df %>%
  ...
  mutate(old.idx = ifelse(age_lower >= 65, 1, 0),
         child.idx = ifelse(age_lower < 15, 1, 0),
...
for(yr in years){
  ...
  pop_by_age_hra[[paste0("acs5_",yr)]] <- tracts_to_hra[[paste0("acs5_", yr)]] %>%
